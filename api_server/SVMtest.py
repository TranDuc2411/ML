...
def evaluate_model_on_test_data(dataset_dir, model_dir):
...
# Đường dẫn đến thư mục chứa dữ liệu và thư mục chứa mô hình đã huấn luyện
dataset_dir = "dataset"
model_dir = "model"

# Đánh giá hiệu suất của mô hình trên dữ liệu kiểm tra
evaluate_model_on_test_data(dataset_dir, model_dir)
